...
function WarningDialog({ title, message, onClickAction, onClickCancel }) {
  return (
    <div className='z-[999] fixed top-0 left-0 h-screen w-screen flex justify-center items-center bg-black/25 backdrop-blur animate-fade-in text-center'>
      <div className='h-[25vh] w-[75vw] min-h-[150px] min-w-[250px] max-h-[200px] max-w-[350px] grid grid-cols-2 grid-rows-auto p-5 rounded-lg bg-dialogBlack border border-white drop-shadow-md items-center justify-center gap-x-3'>
